...
const ADMIN_PAGES = [
  ...
  { path: '/admin/barcodes', label: 'Barcode Tracking', description: 'Track product barcodes and stock units' },
  { path: '/admin/stock-receiving', label: 'Stock Receiving', description: 'Receive incoming stock from suppliers' },
  ...
  { path: '/admin/suppliers', label: 'Suppliers', description: 'Manage suppliers and payments' },
